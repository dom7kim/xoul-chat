  ...
  return (
    <form onSubmit={handleSubmit} className="flex w-full px-1">
      <input
        ...
        className={`flex-grow px-2 py-1 text-sm border rounded-l-md focus:outline-none focus:ring-1 ${
          darkMode
      ...
      <button
        type="submit"
        className={`px-3 py-1 text-sm rounded-r-md focus:outline-none focus:ring-1 transition-colors ${
          isDisabled
